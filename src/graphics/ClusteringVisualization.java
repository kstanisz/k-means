...
public class ClusteringVisualization {
    ...
    private static final Color[] COLORS = {
            ...
            Color.ORANGE, Color.GRAY, Color.MAGENTA, Color.DARK_GRAY, Color.CYAN, Color.LIGHT_GRAY
    };
    ...
    */
    private void scalePoints() {
        ...
        for (Cluster cluster : clusters) {
            ...
            center.setX(center.getX() - smallestX);
            center.setY(center.getY() - smallestY);
    ...
    private void createImage() {
        ...
        for (int i = 0; i < clusters.size(); i++) {
            ...
            drawCircle(g, (int) center.getX(), (int) center.getY(), 5);
        }
